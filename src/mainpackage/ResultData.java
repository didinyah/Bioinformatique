...
public class ResultData {
    ...
    Integer numberCdsSeqInvalid = 0; // Nombre de cds mal formÃ©
    ...
    // cds info
    // Donne le nombre de borne Ã©tant en mode complement (ce n'est pas le nombre de cds en complement)
    Integer cdsBorneComplement = 0;
    //Nombre de CDS qui sont sur plusieurs ligne (peu d'information Ã  part que c'est une grosse jointure)
